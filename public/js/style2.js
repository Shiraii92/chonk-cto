...
function setDefaultChain() {
    ...
    if (selectedChainBtn) {
        selectedChainBtn.innerHTML = `
            <div class="btnlogo btnsize">
                <svg id="base" width="20" height="20" style="margin-right: 12px; width: 20px; height: 20px;">
                    <rect rx="6" fill="#F9F9F9" width="20" height="20"></rect>
                    <rect rx="6" fill="#0052FF33" width="20" height="20"></rect>
